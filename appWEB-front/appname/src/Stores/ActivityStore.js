...
class ActivityStore {
    ...
    async updateCountEmoji1(activityId) {
        ...
        try {
            await fetch(`${SERVER}/activities/${activityId}/update-count-emoji1`, {
                method : 'put'
            })
        } catch (err) {
            console.warn(err)
    ...
    async updateCountEmoji2(activityId) {
        console.log("ActivityStore -> updateCountEmoji1")
        try {
            await fetch(`${SERVER}/activities/${activityId}/update-count-emoji2`, {
                method : 'put'
            })
        } catch (err) {
            console.warn(err)
    ...
    async updateCountEmoji3(activityId) {
        console.log("ActivityStore -> updateCountEmoji1")
        try {
            await fetch(`${SERVER}/activities/${activityId}/update-count-emoji3`, {
                method : 'put'
            })
        } catch (err) {
            console.warn(err)
    ...
    async updateCountEmoji4(activityId) {
        ...
        try {
            await fetch(`${SERVER}/activities/${activityId}/update-count-emoji4`, {
                method : 'put'
            })
        } catch (err) {
            console.warn(err)
    ...
    async updateEmoji(activityID,activity) {
        try {
            await fetch(`${SERVER}/activities/${activityID}`, {
                method: 'put',
                headers: {
